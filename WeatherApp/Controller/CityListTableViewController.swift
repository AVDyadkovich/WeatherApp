...
class CityListTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0{
             cell = createCityCell(cityName: "Vinnitsya", tempreture: "22")
            
        }else {
            cell = createCityCell(cityName: "Kiev", tempreture: "25")
        }
    ...
    */
    ...
    func createCityCell(cityName:String, tempreture:String) -> UITableViewCell{
        ...
        cell.detailTextLabel?.text = tempreture
